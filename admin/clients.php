...
<head>
    <meta charset="UTF-8">
    <title>NewLine Infotech | Invoice</title>
                ...
                <div class="col-xs-12">
                    ...
                    <div class="box">
                        <div class="box-header">
                            <h3 class="box-title">Client list Details</h3>
                        </div><!-- /.box-header -->
                        <div class="box-body">
                            <table id="example1" class="table table-bordered table-striped">
                                ...
                                $s=mysql_query("select * from `clients` ORDER BY `time_stamp` DESC");
                                $i=1;
                                if(mysql_num_rows($s)>0)
                                {
                                    ...
                                    { ?>
                                        ...
                                        <tr>
                                            <td><?php echo $i++; ?></td>
                                            <td><?php echo ucfirst($res['company_name']);?></td>
                                            <td><?php echo ucfirst($res['client_name']);?></td>
                                            <td><?php echo $res['mobile_number'];?></td>
                                            <td><?php echo $res['email'];?></td>
                                            <td><?php echo substr($res['address'],0,10);?></td>
